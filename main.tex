...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{Smart Farm Management Website} $|$ \emph{\href{https://github.com/kng1259/IOT-project}{GitHub}} $|$ \emph{\href{https://drive.google.com/file/d/1wfQdTQRRYYFzMYMofCk8vZTn4HJppBqs/view?usp=sharing}{Architecture Diagram}}}{Jan 2025 - Now}
      ...
      % \resumeProjectHeading
      %   {\textbf{Local Kubernetes Cluster} $|$ \emph{\href{https://github.com/kng1259/talos-libvirt-k8s-cluster}{GitHub}}}{April 2025 - Now}
      %   {Solo project}{}
      %     \resumeItemListStart
      %       \resumeItem{Managed a virtualized multi-node Kubernetes cluster using \textbf{Talos Linux} and \textbf{Vagrant} on a physical host machine}
      %       \resumeItem{Set up \textbf{Longhorn} for distributed storage, \textbf{Prometheus} for metrics and \textbf{Grafana} for visualization}
      %     \resumeItemListEnd
    \resumeSubHeadingListEnd
